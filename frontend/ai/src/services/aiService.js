...
const generateFlashcards = async (documentId, options) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to generate" };
  }
};
...
const generateQuiz = async (documentId, options) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to generate quiz" };
  }
};
...
const generateSummary = async (documentId) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to generate summary" };
  }
};
...
const chat = async (documentId, message) => {
  try {
    ...
    throw e.response?.data || { message: "chat request failed" };
  }
};
...
const explainConcept = async (documentId, concept) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to explain concept" };
  }
};
...
const getChatHistory = async (documentId) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to fetch chat" };
  }
};
