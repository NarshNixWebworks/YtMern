...
const getAllFlashcardSets = async () => {
  try {
    ...
    throw e.response?.data || { message: "Failed to fetch flashcards" };
  }
};
...
const reviewFlashcard = async (cardId, cardIndex) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to reviiew flashcard" };
  }
};
...
const toggleStar = async (cardId) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to star" };
  }
};
...
const deleteFlashcardSet = async (id) => {
  try {
    ...
    throw e.response?.data || { message: "Failed to delete flashcards" };
  }
};

const falshcardService = {
  getAllFlashcardSets,
...
export default falshcardService;
