  ...
  return (
    <>
      <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50">
        <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px, transparent_1px)] bg-size-[16px_16px] opacity-30px" />

        <div className="relative w-full max-w-md px-6">
          <div className="bg-white/80 backdrop-blur-xl vorder border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
            {/* Header */}
          ...
          <div className="space-y-5">
            ...
            >
              ...
              <div className="absolute inset-0 bg-linear-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:transalte-x-full transition-transform duration-700" />
            </button>
          </div>
