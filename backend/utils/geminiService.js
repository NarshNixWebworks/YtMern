...
export const generateQuiz = async (text, numQuestions = 5) => {
  const prompt = `Generate exactly ${numQuestions} mutiple choice questions form the following text.
...
export const explainConcept = async (concept, context) => {
  ...
  Provide a clear, educational explanation that's easy to understand. Include exampled if relevant.
